        ...
        >
            ...
            <div className="relative z-10">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-4">
                    <span className={`block transition-opacity duration-700 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                        More Than a Website.
                    </span>
                    <span className={`block text-cyan-400 transition-opacity duration-700 ease-out delay-200 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                        A Growth Engine.
                    </span>
                </h1>
                <p
                    className={`text-lg md:text-xl text-slate-300 max-w-3xl mx-auto mb-8 transition-opacity duration-700 ease-out delay-400 ${
                ...
                <div
                    className={`flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 transition-opacity duration-700 ease-out delay-500 ${
                        isVisible ? 'opacity-100' : 'opacity-0'
                    }`}
                >
