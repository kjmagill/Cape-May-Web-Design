    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                <h1
                    className={`text-5xl md:text-7xl font-extrabold text-white leading-tight mb-4 transition-all duration-700 ease-out ${
                ...
                <p
                    className={`text-lg md:text-xl text-slate-300 max-w-3xl mx-auto mb-8 transition-all duration-700 ease-out delay-200 ${
                        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                    }`}
                >
                ...
                <div
                    className={`flex justify-center space-x-4 transition-all duration-700 ease-out delay-300 ${
                        isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                    }`}
                >
