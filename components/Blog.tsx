    ...
    return (
        ...
        >
            <div className="container mx-auto px-6">
                ...
                >
                    <h2 className="text-4xl font-extrabold text-white">Cape May Digital Marketing Insights</h2>
                    <p className="text-slate-400 mt-2 max-w-2xl mx-auto">Actionable advice and local marketing tips to help your Cape May business thrive online.</p>
                </div>
